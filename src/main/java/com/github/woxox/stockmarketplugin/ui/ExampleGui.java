...
public class ExampleGui extends Gui {
    ...
    // inventory.setItem(2, createGuiItem(Material.DIAMOND_SWORD, "Example Sword",
    // "First line of the lore", "Second line of the lore"));
    // inventory.setItem(4, createGuiItem(Material.IRON_HELMET, "Example Helmet",
    // "First line of the lore", "Secnd line of the lore"));
